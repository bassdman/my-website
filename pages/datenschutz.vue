  ...
  <article id="post-12" class="post-12 page type-page status-publish hentry content" v-bind:style="{color:textcolor}">
    ...
    <div class="entry-content gbSiteContent">
      ...
      <p>
        ...
        <br />
        <br />Sie haben entsprechend. den gesetzlichen Vorgaben das Recht, die Vervollständigung der Sie betreffenden Daten oder die Berichtigung der Sie betreffenden unrichtigen Daten zu verlangen.
        <br />
        <br />Sie haben nach Maßgabe der gesetzlichen Vorgaben das Recht zu verlangen, dass betreffende Daten unverzüglich gelöscht werden, bzw. alternativ nach Maßgabe der gesetzlichen Vorgaben eine Einschränkung der Verarbeitung der Daten zu verlangen.
        <br />
        <br />Sie haben das Recht zu verlangen, dass die Sie betreffenden Daten, die Sie uns bereitgestellt haben nach Maßgabe der gesetzlichen Vorgaben zu erhalten und deren Übermittlung an andere Verantwortliche zu fordern.
        <br />
        <br />Sie haben ferner nach Maßgabe der gesetzlichen Vorgaben das Recht, eine Beschwerde bei der zuständigen Aufsichtsbehörde einzureichen.
        <br />
      </p>
      ...
      <p>
        <strong>Sie können der künftigen Verarbeitung der Sie betreffenden Daten nach Maßgabe der gesetzlichen Vorgaben jederzeit widersprechen. Der Widerspruch kann insbesondere gegen die Verarbeitung für Zwecke der Direktwerbung erfolgen.</strong>
      </p>
      ...
      <p>
        <span class="ts-muster-content">
          Wir binden die Videos der Plattform “YouTube” des Anbieters Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Datenschutzerklärung:
          <a
            target="_blank"
      ...
      <p>
        <span class="ts-muster-content">
          Wir binden die Funktion zur Erkennung von Bots, z.B. bei Eingaben in Onlineformularen („ReCaptcha“) des Anbieters GGoogle Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Datenschutzerklärung:
          <a
            target="_blank"
            href="https://www.google.com/policies/privacy/"
            rel="noopener noreferrer"
...
export default {
  ...
  created() {
    ...
    this.$store.commit("footer/marginTop");
  },
  computed: {
    textcolor() {
      ...
      meta: [
        {
          name: "description",
          content:
            "DATENSCHUTZERKLÄRUNG Ich freue mich über dein Interesse an meiner Seite. Der Schutz Deiner Privatsphäre ist sehr wichtig. Nachstehend informiere ich dich ausführlich über den Umgang mit ..."
        },
        { name: "robots", content: "noindex,follow" }
      ],
      link: [
        { rel: "canonical", href: "https://www.manuelgelsen.de/datenschutz" },
